...
function ProfilePage() {
  ...
  const [isPrivatized, setIsPrivatized] = useState(false); // New state for privatizing info
  ...
  const handlePrivatizeClick = () => {
    setIsPrivatized((prevState) => !prevState);
  };
          ...
          <div className="info-grid">
            <div className="info-item">
              ...
              {isEditing ? (
                ...
                <p>{isPrivatized ? 'Private' : user.displayName}</p>
              )}
            </div>
            <div className="info-item">
              <h3>Email</h3>
              {isEditing ? (
                ...
                <p>{isPrivatized ? 'Private' : user.email}</p>
              )}
            </div>
          </div>
          {isEditing ? (
            ...
            <div className="button-group">
              ...
              <button className="privatize-button" onClick={handlePrivatizeClick}>
                {isPrivatized ? 'Unprivatize' : 'Privatize'}
              </button>
            </div>
          )}
        </section>
